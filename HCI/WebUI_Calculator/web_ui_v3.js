    ...
    WebUI.app = new WebUI.Row({
        children: [
            ...
            new WebUI.Container({
                ...
                horizontal_alignment: WebUI.Alignment.CENTER,
                vertical_alignment: WebUI.Alignment.CENTER,
                children: [ new WebUI.TextField(displayValue, {width:800, height:50}) ],
            }),
           
            new WebUI.Column({
                desired_size: { width: 100, height: 250 },
                horizontal_alignment: WebUI.Alignment.CENTER,
                vertical_alignment: WebUI.Alignment.CENTER,
                children: 
                [
                    new WebUI.Row({
                        desired_size: {width: 300, height: 200},
                        horizontal_alignment: WebUI.Alignment.LEFT,
                        vertical_alignment: WebUI.Alignment.LEFT,
                        children: [ 
                            new WebUI.Text("Number", { text_color: 'pink', font_size: 36 }), 
                            new WebUI.GridView(3,4,{
                                children: [
                                    ...
                                    new WebUI.CalcButton("10", {width:50, height:50}),
                                    new WebUI.CalcButton("100", {width:50, height:50}),
                    ...
                    new WebUI.Row({
                        ...
                        vertical_alignment: WebUI.Alignment.LEFT,
                        children: [ 
                            new WebUI.Text("Operator", { text_color: 'skyblue', font_size: 36 }), 
                    
                            new WebUI.GridView(4,3,{
                                children: [
                ...
                vertical_alignment: WebUI.Alignment.CENTER,
                    ...
                    [
                        new WebUI.Row({
                            ...
                            vertical_alignment: WebUI.Alignment.LEFT,
                            children: [ 
                                new WebUI.Text("Bracket", { text_color: 'green', font_size: 36 }), 
                                new WebUI.GridView(3,5,{
                                    children: [
                                        new WebUI.CalcButton("(", {width:50, height:50}),
                                        new WebUI.CalcButton(")", {width:50, height:50}),
                                        new WebUI.CalcButton("[", {width:50, height:50}),
                        ...
                        new WebUI.Row({
                            ...
                            vertical_alignment: WebUI.Alignment.LEFT,
                            children: [ 
                                new WebUI.Text("Characters", { text_color: 'red', font_size: 36 }), 
                        ...
                        new WebUI.Row({
                            ...
                            vertical_alignment: WebUI.Alignment.LEFT,
                            children: [ 
                                new WebUI.Text("Special formula", { text_color: 'yellow', font_size: 36 }), 
                                new WebUI.GridView(3,5,{
                                    children: [
                                        ...
                                        new WebUI.CalcButton("asin", {width:50, height:50}),
                                        new WebUI.CalcButton("asinh", {width:50, height:50}),
                                        new WebUI.CalcButton("cos", {width:50, height:50}),
                                        new WebUI.CalcButton("acos", {width:50, height:50}),
                                        new WebUI.CalcButton("acosh", {width:50, height:50}),
                                        new WebUI.CalcButton("tan", {width:50, height:50}),
                                        new WebUI.CalcButton("atan", {width:50, height:50}),
                                        new WebUI.CalcButton("atanh", {width:50, height:50}),
            ...
            new WebUI.Column({
                ...
                children: [
                    new WebUI.Row({
                            ...
                            vertical_alignment: WebUI.Alignment.LEFT,
                            children: [ 
                                new WebUI.Text("Calculate", { text_color: 'purple', font_size: 36 }), 
                                new WebUI.GridView(3,5,{
                                     children: [
                    ...
                    new WebUI.Row({
                            ...
                            vertical_alignment: WebUI.Alignment.LEFT,
                            children: [ 
                                new WebUI.Text("Result", { text_color: 'magenta', font_size: 36 }), 
                                new WebUI.GridView(1,5,{
                                     children: [
                                        new WebUI.CalcSave(displayValue, {width:50, height:50}),
...
// GridView 위젯 추가
WebUI.GridView = function(row, column, properties) {
    WebUI.Widget.call(this, properties);
...
WebUI.GridView.prototype.extendSizeChildren = function(size, child_size) {
    ...
    size.width += child_size.width/this.row;
    size.height += child_size.height/this.column;
    return size;
}
...
WebUI.GridView.prototype.calcNextPosition = function(position, size) {
    ...
    if(this.temp - this.row == 0) {
        next_left = next_left - size.width * this.row;
        next_top = next_top + size.height;
        this.temp = this.temp - this.row;
    }
...
// CalcSave 위젯 추가
WebUI.CalcSave = function(label, properties) {
    // COPY HERE!
    WebUI.Widget.call(this, properties);
    this.type = WebUI.WidgetTypes.CalcSave;
    this.label = label;
    this.font_family = 'System';
    this.font_size = 20;
    this.font_weight = 'bold';
...
WebUI.CalcSave.prototype = Object.create(WebUI.Widget.prototype);
WebUI.CalcSave.prototype.constructor = WebUI.CalcSave;

WebUI.CalcSave.prototype.initVisualItems = function() {
        let text = new fabric.Text(this.label, {
            left: this.position.left,
            top: this.position.top,
            selectable: false,
...
WebUI.CalcButton = function(label, desired_size) {
    ...
    WebUI.PushButton.call(this); // PushButton 상속
...
WebUI.CalcButton.prototype = Object.create(WebUI.PushButton.prototype); // PushButton상속
...
WebUI.CalcButton.prototype.handleButtonPushed = function() {
    ...
    if (this.visual_items[1].text == 'EV') {
        ...
        if (this.visual_items[1].text == 'CL') {
            displayValue = '0';
            WebUI.initialize(); // 갱신
            test = false;
        }
        ...
        {
            displayValue = displayValue + this.visual_items[1].text;
            WebUI.initialize(); // 갱신
        }
    }
...
WebUI.Switch.prototype.initVisualItems = function() {
    ...
    let background = new fabric.Path('M' + radius + ',' + 0 + 
                 'A' + radius + ',' + radius + ' ' 
                    + '0,0,0 '  + radius + ',' + radius*2+
                    'L'+  radius*3 + ' ' + radius*2+
                    'A' + radius + ',' + radius + ' ' 
                    + '0,0,0 ' + radius*3 + ',' + 0+
                    'Z', {
...
WebUI.Switch.prototype.handleMouseDown = function() {
    ...
    if(this.is_on ==false)
    {
        ...
        this.visual_items[1].animate('left',  this.visual_items[0].left + radius*2.1  , {
            duration: 100, 
            onChange: WebUI.canvas.renderAll.bind(WebUI.canvas),
            onComplete: this.is_on = true,
        })
    }
    ...
    else
    {
        ...
        this.visual_items[1].animate('left',  this.visual_items[0].left + radius*0.1  , {
            duration: 100, 
            onChange: WebUI.canvas.renderAll.bind(WebUI.canvas),
            onComplete: this.is_on = false,
        })
