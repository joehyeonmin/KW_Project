...
void init()
{
	...
	cout << "Keyboard Input: right for adjust the shininess coefficient of a point light" << endl;
	cout << "Keyboard Input: left for adjust the shininess coefficient of a point light" << endl;
