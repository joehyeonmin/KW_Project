...
struct Box : Shape {
	Box(Point xy, int width, int height, int arc_radius) :w(width), h(height), arc(arc_radius)
	{
		add(xy);
	}
...
struct Regular_polygon : Shape {
	Regular_polygon(Point xy, int num, int rad) :n{ num }, r{ rad }
	{
		add(xy);
	}
...
struct Star : Shape {
	Star(Point xy, int num, int rad_1, int rad_2) :n{ num }, r1{ rad_1 }, r2{ rad_2 }
	{
		add(xy);
	}
...
struct Rose : Shape {
	Rose(Point xy, int num, int deno, int rad) :n{ num }, d{ deno }, r{ rad }
	{
		add(xy);
	}
...
struct Bug : Shape {	
	Bug(Point p, int num, int rad_1, int rad_2)	:n{ num }, r1{ rad_1 }, r2{ rad_2 }
	{
		add(p);
